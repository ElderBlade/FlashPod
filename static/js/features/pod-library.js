...
export class PodLibrary {
    ...
    createPodCard(pod) {
        ...
        return `
            <div class="pod-card bg-white dark:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-200 border border-gray-200 dark:border-gray-700" data-pod-id="${pod.id}">
                <div class="p-6">
                    <!-- Pod Header -->
                    <div class="flex items-start justify-between mb-3">
                        ...
                        <div class="ml-2 flex-shrink-0">
                            <button class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" onclick="app.showPodMenu(${pod.id}, event)">
